	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="alugar.php" class="nav-link">Alugar</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 mb-5 text-center">
            <h1 class="mb-3 bread">Alugar</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Inicio <i class="ion-ios-arrow-forward"></i></a></span> <span>Alugar <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            <h2 class="mb-4">Confira todos os imóveis disponíveis para alugar:</h2>
		...
		while($row_imovel = mysqli_fetch_assoc($resultado_imovel)){
			...
			echo "
    			...
    			<div class='col-md-6 col-lg-3 ftco-animate'>
					...
					<a href='proc_apagar_imovel.php?id=$id_imovel'>Apagar</a>-->
		...
		$max_links = 2;
		echo "<li><a href='alugar.php?pagina=1#itens'>&lt;</a></li> ";
		
		for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
			if($pag_ant >= 1){
				echo "<li><a href='alugar.php?pagina=$pag_ant#itens'>$pag_ant</a></li> ";
			}
		}
		...
		for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
			if($pag_dep <= $quantidade_pg){
				echo "<li><a href='alugar.php?pagina=$pag_dep#itens'>$pag_dep</a></li> ";
			}
		}
		
		echo "<li><a href='alugar.php?pagina=$quantidade_pg#itens'>&gt;</a></li>";
